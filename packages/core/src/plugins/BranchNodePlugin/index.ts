...
import { NodeStatus,BuiltInPluginNodeTypes } from "../../constants"
import type { ExecutionHistory, Node, Edge } from "../../types"
...
export class BranchNodePlugin extends BaseNodePlugin {
   ...
   * 节点类型
   */
  public pluginNodeType = BuiltInPluginNodeTypes.Branch;
  /**
   * 节点类型名称
   */
  public pluginNodeTypeName = "分支节点";
