...
- 相关类型速查：参见 [Schema](./types.md#schema)、[Field](./types.md#field)、[NodeConfig](./types.md#nodeconfig)、[BaseWidgetProps](./types.md#basewidgetprops)、[WidgetProps](./types.md#widgetprops)
